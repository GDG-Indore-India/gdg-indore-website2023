...
function TensorFlowFeatures(){
    return(
        <>
             <div className="grid place-items-center w-full">
            <div className="max-w-5xl py-24 content-center justify-center">
                <h1 className="text-3xl  text-center font-bold">What does tensorflow Indore brings you at our events/workshops</h1>
                <div className="grid mt-12 md:grid-cols-3 grid-cols-1 gap-8">
                {
                    TensorFlowFeaturesData.map((i, k) => {
                        return(
...
export default TensorFlowFeatures
