  ...
  return (
    <div className="w-[250px] h-[300px] rounded-md flex flex-col justify-around items-center p-5 bg-white border shadow-md">
      ...
      <div className="w-full flex flex-col text-center items-center">
        <h1 className="font-semibold text-primary-black text-xl mb-1 text-center">
          {props.name}
        </h1>
        <p className="text-sm text-gray-600">{props.designation}</p>
      </div>
      <div className="w-full px-2 flex justify-center gap-3">
        {/* Linkedin */}
        <div className="profile_card_icons">
        ...
        {/* Twitter */}
        <div className="profile_card_icons">
          <Link href={props.social.twitter}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              fill="currentColor"
